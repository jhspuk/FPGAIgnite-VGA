...
#
# Generated by Vivado on Thu Aug 08 20:21:55 CEST 2024
...
xv_boost_lib_path=/opt/tools/Xilinx/Vivado/2020.1/tps/boost_1_64_0
xvlog_opts="--relax"
...
{
  file="xsim.ini"
  lib_map_path="/opt/tools/Xilinx/Vivado/2020.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
